...
\\000"
 ...
 (1, 
"\000\000\000\000\000\000\000\000\000\036\037\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\036\000\000\034\000\000\032\000\031\030\029\028\000\027\000\000\
...
\\000"
 ...
 (37, 
"\000\000\000\000\000\000\000\000\000\038\037\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
...
{fin = [(N 67)], trans = 7},
{fin = [(N 67)], trans = 8},
{fin = [(N 46),(N 67)], trans = 7},
{fin = [(N 67)], trans = 10},
{fin = [(N 67)], trans = 11},
{fin = [(N 43),(N 67)], trans = 7},
{fin = [(N 67)], trans = 13},
{fin = [(N 67)], trans = 14},
{fin = [(N 67)], trans = 15},
{fin = [(N 51),(N 67)], trans = 7},
{fin = [(N 35)], trans = 0},
{fin = [(N 33)], trans = 0},
{fin = [(N 56)], trans = 0},
{fin = [(N 23)], trans = 20},
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  10 => let val yytext=yymktext() in (*#line 60.19 "expr.lex"*) let val old = !lineRef
		 ...
		 (*#line 337.1 "expr.lex.sml"*)
 end
| 15 => let val yytext=yymktext() in (*#line 64.29 "expr.lex"*) Tokens.CONST (toInt yytext, !lineRef, !lineRef) (*#line 339.1 "expr.lex.sml"*)
 end
| 17 => ((*#line 65.29 "expr.lex"*) Tokens.PLUS  (!lineRef,!lineRef) (*#line 341.1 "expr.lex.sml"*)
)
| 19 => ((*#line 66.29 "expr.lex"*) Tokens.MINUS  (!lineRef,!lineRef) (*#line 343.1 "expr.lex.sml"*)
)
| 21 => ((*#line 67.29 "expr.lex"*) Tokens.MUL (!lineRef,!lineRef) (*#line 345.1 "expr.lex.sml"*)
)
| 23 => ((*#line 68.29 "expr.lex"*) Tokens.EQUALSIGN (!lineRef,!lineRef) (*#line 347.1 "expr.lex.sml"*)
)
| 25 => ((*#line 69.29 "expr.lex"*) Tokens.LPAREN (!lineRef,!lineRef) (*#line 349.1 "expr.lex.sml"*)
)
| 27 => ((*#line 70.29 "expr.lex"*) Tokens.RPAREN (!lineRef,!lineRef) (*#line 351.1 "expr.lex.sml"*)
)
| 29 => ((*#line 71.29 "expr.lex"*) Tokens.LCURL (!lineRef,!lineRef) (*#line 353.1 "expr.lex.sml"*)
)
| 3 => ((*#line 58.19 "expr.lex"*) updateLine 1; lex ()(*#line 355.1 "expr.lex.sml"*)
)
| 31 => ((*#line 72.29 "expr.lex"*) Tokens.RCURL (!lineRef,!lineRef) (*#line 357.1 "expr.lex.sml"*)
)
| 33 => ((*#line 73.29 "expr.lex"*) Tokens.LSQUARE (!lineRef,!lineRef) (*#line 359.1 "expr.lex.sml"*)
)
| 35 => ((*#line 74.29 "expr.lex"*) Tokens.RSQUARE (!lineRef,!lineRef) (*#line 361.1 "expr.lex.sml"*)
)
| 37 => ((*#line 75.29 "expr.lex"*) Tokens.SEMICOLON (!lineRef,!lineRef) (*#line 363.1 "expr.lex.sml"*)
)
| 39 => ((*#line 76.29 "expr.lex"*) Tokens.COLON (!lineRef,!lineRef) (*#line 365.1 "expr.lex.sml"*)
)
| 43 => ((*#line 78.29 "expr.lex"*) Tokens.FUN (!lineRef,!lineRef)(*#line 367.1 "expr.lex.sml"*)
)
| 46 => ((*#line 80.29 "expr.lex"*) Tokens.IF (!lineRef,!lineRef)(*#line 369.1 "expr.lex.sml"*)
)
| 51 => ((*#line 81.29 "expr.lex"*) Tokens.ELSE (!lineRef,!lineRef)(*#line 371.1 "expr.lex.sml"*)
)
| 54 => ((*#line 82.29 "expr.lex"*) Tokens.EQ (!lineRef,!lineRef) (*#line 373.1 "expr.lex.sml"*)
)
| 56 => ((*#line 83.29 "expr.lex"*) Tokens.GT (!lineRef,!lineRef) (*#line 375.1 "expr.lex.sml"*)
)
| 58 => ((*#line 84.29 "expr.lex"*) Tokens.LT (!lineRef,!lineRef) (*#line 377.1 "expr.lex.sml"*)
)
| 6 => ((*#line 59.19 "expr.lex"*) lex() (*#line 379.1 "expr.lex.sml"*)
)
| 61 => ((*#line 85.29 "expr.lex"*) Tokens.AND (!lineRef,!lineRef) (*#line 381.1 "expr.lex.sml"*)
)
| 64 => ((*#line 86.29 "expr.lex"*) Tokens.OR (!lineRef,!lineRef) (*#line 383.1 "expr.lex.sml"*)
)
| 67 => let val yytext=yymktext() in (*#line 88.29 "expr.lex"*) Tokens.IDENTIFIER(yytext ,!lineRef, !lineRef)(*#line 385.1 "expr.lex.sml"*)
 end
