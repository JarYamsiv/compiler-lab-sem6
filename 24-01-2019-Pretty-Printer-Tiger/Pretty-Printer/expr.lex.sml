...
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\012\000\000\010\000\000\000\000\000\000\009\008\000\007\000\000\
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  10 => let val yytext=yymktext() in (*#line 60.19 "expr.lex"*) let val old = !lineRef
		 ...
		 (*#line 214.1 "expr.lex.sml"*)
 end
| 15 => let val yytext=yymktext() in (*#line 64.19 "expr.lex"*) Tokens.CONST (toInt yytext, !lineRef, !lineRef) (*#line 216.1 "expr.lex.sml"*)
 end
| 17 => ((*#line 65.19 "expr.lex"*) Tokens.PLUS  (!lineRef,!lineRef) (*#line 218.1 "expr.lex.sml"*)
)
| 19 => ((*#line 66.19 "expr.lex"*) Tokens.MINUS  (!lineRef,!lineRef) (*#line 220.1 "expr.lex.sml"*)
)
| 21 => ((*#line 67.19 "expr.lex"*) Tokens.MUL (!lineRef,!lineRef) (*#line 222.1 "expr.lex.sml"*)
)
| 23 => ((*#line 68.19 "expr.lex"*) Tokens.EQUALSIGN (!lineRef,!lineRef) (*#line 224.1 "expr.lex.sml"*)
)
| 26 => let val yytext=yymktext() in (*#line 69.28 "expr.lex"*)Tokens.IDENTIFIER(yytext ,!lineRef, !lineRef)(*#line 226.1 "expr.lex.sml"*)
 end
| 3 => ((*#line 58.19 "expr.lex"*) updateLine 1; lex ()(*#line 228.1 "expr.lex.sml"*)
)
| 6 => ((*#line 59.19 "expr.lex"*) lex() (*#line 230.1 "expr.lex.sml"*)
)
