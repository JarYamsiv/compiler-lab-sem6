...
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\014\000\000\012\000\000\000\000\000\000\000\000\000\000\000\008\
...
\\000"
 ...
 (15, 
"\000\000\000\000\000\000\000\000\000\016\015\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  10 => let val yytext=yymktext() in (*#line 60.19 "expr.lex"*) let val old = !lineRef
		 ...
		 (*#line 238.1 "expr.lex.sml"*)
 end
| 16 => ((*#line 64.29 "expr.lex"*)lex()(*#line 240.1 "expr.lex.sml"*)
)
| 18 => ((*#line 66.29 "expr.lex"*) Tokens.EPS(!lineRef, !lineRef)(*#line 242.1 "expr.lex.sml"*)
)
| 21 => let val yytext=yymktext() in (*#line 67.29 "expr.lex"*) Tokens.IDENTIFIER(yytext ,!lineRef, !lineRef)(*#line 244.1 "expr.lex.sml"*)
 end
| 23 => ((*#line 68.29 "expr.lex"*) Tokens.COLON(!lineRef, !lineRef)(*#line 246.1 "expr.lex.sml"*)
)
| 25 => ((*#line 69.29 "expr.lex"*) Tokens.BAR(!lineRef, !lineRef)(*#line 248.1 "expr.lex.sml"*)
)
| 27 => ((*#line 70.29 "expr.lex"*) Tokens.SEMICOLON(!lineRef, !lineRef)(*#line 250.1 "expr.lex.sml"*)
)
| 3 => ((*#line 58.19 "expr.lex"*) updateLine 1; lex ()(*#line 252.1 "expr.lex.sml"*)
)
| 6 => ((*#line 59.19 "expr.lex"*) lex() (*#line 254.1 "expr.lex.sml"*)
)
